  ...
  <div class="login-page">
    ...
    <div class="login-hero">
      ...
      <div class="login-hero__inner">
        <h1 class="login-title">Restablecer<span class="login-title--light">Contraseña</span></h1>
        <p class="login-subtitle">Crea una nueva contraseña segura para tu cuenta.</p>
      </div>
    </div>
      ...
      <div class="login-body__inner">
        <div class="login-card">
          ...
          <div class="login-header">
            ...
            <p class="login-desc">Tu nueva contraseña debe tener al menos 6 caracteres.</p>
          </div>
          ...
          <div class="login-form">
            ...
            <div class="form-group">
              ...
              <input type="password" class="form-input" v-model="form.password_confirmation" placeholder="••••••••" />
            </div>
    ...
    <Transition name="modal">
      <div v-if="showSuccessModal" class="modal-overlay" @click.self="goToLogin">
        <div class="modal-card">
          ...
          <h2 class="modal-title">¡Contraseña actualizada!</h2>
          <p class="modal-text">Tu contraseña se ha cambiado exitosamente.<br>Ahora puedes iniciar sesión con tu nueva contraseña.</p>
          <button class="modal-btn" @click="goToLogin">Ir a Iniciar Sesión</button>
        </div>
      </div>
    </Transition>
...
export default {
  ...
  created() {
    ...
    if (!this.email || !this.token) {
      this.errorMsg = 'El enlace de recuperación es inválido o está incompleto.'
    }
  },
  methods: {
    async handleSubmit() {
      ...
      if (!this.email || !this.token) {
        this.errorMsg = 'El enlace de recuperación es inválido.'
        return
      }
      ...
      try {
        ...
        if (error.response) {
          if (error.response.status === 422 && error.response.data.errors) {
            ...
            this.errorMsg = error.response.data.message || 'Error al restablecer la contraseña.'
          }
        } else {
...
<style scoped>
/* ── Estilos base copiados de login.vue y ForgotPassword.vue ── */
.login-page {
